...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-[100dvh] h-[100dvh] bg-black overflow-hidden flex flex-col">
      {/* Header / HUD */}
      <header className="absolute top-0 left-0 w-full p-4 pt-6 md:pt-4 z-20 flex justify-between items-center pointer-events-none bg-gradient-to-b from-black/90 to-transparent">
        ...
        <div className="text-green-800 text-[10px] md:text-xs flex gap-2 md:gap-4 font-mono pointer-events-auto items-center">
          ...
          <div className="hidden sm:flex items-center gap-2 px-2 py-1 bg-green-900/20 border border-green-500/30 rounded">
            <span>SYS.STATUS: ONLINE</span>
          </div>
          <span className="animate-pulse hidden md:block self-center">REC ●</span>
        </div>
      </header>
